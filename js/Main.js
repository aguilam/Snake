...
function tickMethods(){
  ...
  gameOverCheck()
  speedModificator = 1400 / (GameConfig.FieldSize.colCount * GameConfig.FieldSize.rowCount - 2)
...
function gameOverCheck() {
  if (
    ...
    snake.body.some((segment, index) => {return snake.body.slice(index + 1).some(otherSegment => {return segment.x === otherSegment.x && segment.y === otherSegment.y;});})) {
    gameOver()
  }
}
function gameOver() {
